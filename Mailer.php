 ...
 *
 * @package biozahard/mailjet
 */

namespace biozahard\mailjet;
...
class Mailer extends BaseMailer
{
    ...
    */
    public $messageClass = 'biozahard\mailjet\Message';
    ...
    */
    ...
    public function createMailjet()
    {
        ...
        $mj = new \Mailjet\Client($this->_apikey, $this->_secret,true,['version' => $this->version]);
